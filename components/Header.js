...
const Header = () => {
  ...
  <header data-target-header="header">
    ...
    <div class="header__inner">
      ...
      <a href="<?php echo home_url('/'); ?>concierge" data-vars-click-id="menu--cv--concierge" class="navMenu__btn--secondary item--pc">
        <p class="u-fs18">保育ICT化無料相談</p>
      </a>
    </div>
    <nav class="navMenu">
      <div class="navMenu__inner">
        ...
        <ul class="navMenuList">
          <li class="navMenuList__item"><a data-micromodal-trigger="modal-2" data-vars-click-id="link--cv--side--bnr-download" id="bnr--download" class="navMenuItem">
              <img src="/sprite/download.svg" alt=""/>
              <span class="navMenuItem__txt">保育ICTシステム<br/>比較資料DL</span></a>
          </li>
          <li class="navMenuList__item"><a href="<?php echo home_url('/'); ?>flow" class="navMenuItem">
              <img src="/sprite/step.svg" alt=""/>
