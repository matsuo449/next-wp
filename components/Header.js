    ...
    <header data-target-header="header">
      <div class="header__news">
        <div data-header="newswrap" class="header__news__inner">
          <p data-header="newstxt" class="header__news__inner__txt"></p>
        </div>
      </div>
      <div class="header__inner">
        <h1 class="header__logo">
          <a href="/">
            <img src="/svg/logo.svg" alt="ICTキッズ" />
            <br />
            <span class="item--pc">
              幼稚園・保育園ICTシステム比較ならICTキッズ
            </span>
          </a>
        </h1>
        ...
        <a
          href="/"
          data-vars-click-id="menu--cv--concierge"
          class="navMenu__btn--secondary item--pc"
        >
      ...
      <nav class="navMenu">
        <div class="navMenu__inner">
          ...
          <ul class="navMenuList">
            ...
            <li class="navMenuList__item">
              <a href="<?php echo home_url('/'); ?>flow" class="navMenuItem">
            ...
            <li class="navMenuList__item">
              <a
                ...
                data-vars-click-id="menu--cv--compare"
                class="navMenuItem"
              >
                <svg role="img" width="40" height="30">
            ...
            <li data-trigger-submenu="info" class="navMenuList__item">
              ...
              <ul
                data-target-submenu="info"
                class="header__menu__list__subMenu"
              >
                <li class="subMenu__item">
                  <a
                    href="' . $cat_link . '"
                    class="subMenu__item__link c-ico--arrow--r"
                  >
                    <span></span>
                  </a>
                </li>
